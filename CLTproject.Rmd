...
```
This graph looks a lot more unimodal compared to the sample size of 9 graph, but still some tiny bumps near/on the middle of the graph. This graph has a sample size of 16 and the standard deviation for this is `r sd(my1000$k16)`. The standard deviation decreased compared to the sample size of 9 data.